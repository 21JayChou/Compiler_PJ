...
static const flex_int16_t yy_accept[92] =
    {   0,
        0,    0,    0,    0,    0,    0,   49,   47,    9,    8,
       22,   47,   24,   25,   12,   10,   30,   11,   34,   13,
       45,   45,   33,   31,   16,   23,   14,   46,   26,   27,
       46,   46,   46,   46,   46,   46,   46,   46,   46,   28,
       47,   29,    4,    3,    7,    6,    7,   19,   20,   32,
        2,    1,   45,   17,   18,   15,   46,   46,   46,   46,
       40,   36,   46,   46,   46,   46,   46,   21,    5,   46,
       46,   46,   39,   35,   41,   46,   46,   46,   46,   37,
       46,   46,   43,   46,   46,   38,   46,   42,   46,   44,
        0
...
YY_RULE_SETUP
#line 37 "lexer.lex"
{ yylval.pos = A_Pos(line, col); col += yyleng; return CEQ; }
	YY_BREAK
case 19:
YY_RULE_SETUP
#line 38 "lexer.lex"
...
YY_RULE_SETUP
#line 48 "lexer.lex"
{ yylval.pos = A_Pos(line, col); col += yyleng; return LSQ; }
	YY_BREAK
case 27:
YY_RULE_SETUP
#line 49 "lexer.lex"
{ yylval.pos = A_Pos(line, col); col += yyleng; return RSQ; }
	YY_BREAK
case 28:
YY_RULE_SETUP
#line 50 "lexer.lex"
...
YY_RULE_SETUP
#line 54 "lexer.lex"
{ yylval.pos = A_Pos(line, col); col += yyleng; return SEMI; }
	YY_BREAK
case 32:
YY_RULE_SETUP
#line 55 "lexer.lex"
{ yylval.pos = A_Pos(line, col); col += yyleng; return RARROW; }
	YY_BREAK
case 33:
YY_RULE_SETUP
#line 56 "lexer.lex"
